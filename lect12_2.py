...
"""
import pandas as pd 
tr = pd.read_csv("C:\\Users\\Catholic\\abcd\\my_first_repository\\data\\train.csv")
...
#tr.CabinCate = tr.Cabinate.astype(int)
print(tr.dtypes)
print(tr)
print(tr["CabinCate"].value_counts())
...
x_mn,x_max,y_min,y_min = plt.axis()
print(x_mn,x_max,y_min,y_min)
#plt.axis([x_mn,x_max,y_min,y_min])
