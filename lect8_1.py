...
class Champion :
    ...
    def setAtkSpd(self):
        self.atSpd = 0.658((1.0034)**(Champion. lv - 1))
    ...
    def beAtk(self,dem) :
        ...
        def setMovSpd(self):
            ...
            def printStatus(self):
                print("chapNam:%s, hp:%f, lv:%d, mvSpd:%f, atkSpd:%f"%(self.chmpNam, self))
...
user1 = Person("Alice", 20, "01011112222")
