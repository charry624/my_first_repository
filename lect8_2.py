...
decmp = zlib.decompress(cmp).decode(encoding="utf-8")
print(decmp)
...
decmp=bz2.decompress(cmp).decode(encoding="utf-8")
print(decmp)
print("\n=====================\n")
print(len(decmp))
...
parser.add_argument('-s', '--sub', type=int, nargs='+', metavar='N', help='뺼 숫자')
...
if args.sub:
    print("결과 %d입니다." % functools.reduce(lambda x, y: x + y, args.add))